 ...
 */
final class Version20200410183159 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE oc_pharmacy_drgus (drug_id INT NOT NULL, pharmacy_id INT NOT NULL, INDEX IDX_D323A130AABCA765 (drug_id), INDEX IDX_D323A1308A94ABE2 (pharmacy_id), PRIMARY KEY(drug_id, pharmacy_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('ALTER TABLE oc_pharmacy_drgus ADD CONSTRAINT FK_D323A130AABCA765 FOREIGN KEY (drug_id) REFERENCES drug (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE oc_pharmacy_drgus ADD CONSTRAINT FK_D323A1308A94ABE2 FOREIGN KEY (pharmacy_id) REFERENCES pharmacy (id) ON DELETE CASCADE');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP TABLE oc_pharmacy_drgus');
