 ...
 */
final class Version20200403112418 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE advert (id INT AUTO_INCREMENT NOT NULL, content VARCHAR(200) NOT NULL, date DATE NOT NULL, title VARCHAR(200) NOT NULL, author VARCHAR(200) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE media CHANGE pharmacy_id pharmacy_id INT DEFAULT NULL, CHANGE deleted_at deleted_at DATETIME DEFAULT NULL, CHANGE treated_at treated_at DATETIME DEFAULT NULL');
