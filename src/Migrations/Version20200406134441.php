 ...
 */
final class Version20200406134441 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE pharmacy ADD logo_id INT DEFAULT NULL, CHANGE address_id address_id INT DEFAULT NULL, CHANGE user_id user_id INT DEFAULT NULL, CHANGE updated_at updated_at DATETIME DEFAULT NULL, CHANGE deleted_at deleted_at DATETIME DEFAULT NULL');
        $this->addSql('ALTER TABLE pharmacy ADD CONSTRAINT FK_D6C15C1EF98F144A FOREIGN KEY (logo_id) REFERENCES media (id)');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_D6C15C1EF98F144A ON pharmacy (logo_id)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE oc_advert CHANGE image_id image_id INT DEFAULT NULL, CHANGE updated_at updated_at DATETIME DEFAULT \'NULL\'');
        $this->addSql('ALTER TABLE pharmacy DROP FOREIGN KEY FK_D6C15C1EF98F144A');
        $this->addSql('DROP INDEX UNIQ_D6C15C1EF98F144A ON pharmacy');
        $this->addSql('ALTER TABLE pharmacy DROP logo_id, CHANGE address_id address_id INT DEFAULT NULL, CHANGE user_id user_id INT DEFAULT NULL, CHANGE updated_at updated_at DATETIME DEFAULT \'NULL\', CHANGE deleted_at deleted_at DATETIME DEFAULT \'NULL\'');
